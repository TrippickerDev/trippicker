  ...
  return (
    <div className="h-auto flex flex-col justify-center max-w-4xl mx-auto p-4">
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-2">
          <Label
            className="text-lg mdProof of bike ownership certificate:text-xl font-bold"
            htmlFor="firstName"
          >
            Proof of bike ownership certificate
          </Label>
          <p className="text-gray-400">
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-400">Provide the company Logo</p>
          <div className="border-dashed border-[#5800ff] flex-col h-auto rounded-xl my-auto py-2 space-y-3 flex justify-center items-center w-full border">
            <input
              type="file"
              id="certificate"
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-400">Provide The Admin Photo</p>
          <div className="border-dashed border-[#5800ff] flex-col h-auto rounded-xl my-auto py-2 space-y-3 flex justify-center items-center w-full border">
            <input
              type="file"
              id="insurance"
